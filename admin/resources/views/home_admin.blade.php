                ...
                <div class="card-body">
                    ...
                    <div class="col-md-12">
                        <div class="chart-responsive">
                            ...
                            <canvas id="topSpecialties" height="auto" width="198" class="chartjs-render-monitor"></canvas>
                        </div>
                        <!-- ./chart-responsive -->
                    </div>
                    <!-- /.col -->
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row" id="doctorsAttendances">
                    <canvas id="bar-chart" width="800" height="583"></canvas>
                </div>
                <!-- /.row -->
            </div>
            <!-- ./card-body -->
            ...
            <div class="table-responsive">
                <table class="table m-0 table-striped table-valign-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ Carbon\Carbon::parse($attendance->start_date)->format('d/m/Y') }} {{ Carbon\Carbon::parse($attendance->start_date)->format('H:i') . ' às ' . Carbon\Carbon::parse($attendance->end_date)->format('H:i')}}</td>
